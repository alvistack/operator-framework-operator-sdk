...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.31.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.31.0 \
            ...
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.31.0 \
        " \
