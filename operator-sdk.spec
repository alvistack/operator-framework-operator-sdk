...
Requires: ansible-operator-plugins >= 1.35.0
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.35.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.35.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=e95abdbd5ccb7ca0fd586e0c6f578e491b0a025b \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.28.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.35.0 \
        " \
