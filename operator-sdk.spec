...
Requires: ansible-operator-plugins >= 1.32.0
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.32.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.32.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=4dcbbe343b29d325fd8a14cc60366335298b40a3 \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.26.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.32.0 \
        " \
