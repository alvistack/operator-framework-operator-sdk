...
Requires: ansible-operator-plugins >= 1.34.0
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.34.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.34.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=4e01bcd726aa8b0e092fcd3ab874961e276f3db3 \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.28.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.34.0 \
        " \
