...
Requires: ansible-operator-plugins >= 1.34.1
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.34.1 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.34.1 \
            ...
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.34.1 \
        " \
