...
Requires: ansible-operator-plugins >= 1.34.2
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.34.2 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.34.2 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=81dd3cb24b8744de03d312c1ba23bfc617044005 \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.28.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.34.2 \
        " \
