...
Requires: ansible-operator-plugins >= 1.42.1
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.42.1 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.42.1 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=3d5ab21480e6d262e649c8f6097b9aa0371b2b12 \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.33.1 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.42.1 \
        " \
