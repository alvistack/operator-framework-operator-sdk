...
Requires: ansible-operator-plugins >= 1.36.1
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.36.1 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.36.1 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=37d2f2872bfecd6927469f384be4951805aa4caa \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.29.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.36.1 \
        " \
