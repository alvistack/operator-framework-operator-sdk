...
Requires: ansible-operator-plugins >= 1.36.0
...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.36.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.36.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=72167bf0fab99c2b533cf20f8d1c405616f15cf1 \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.28.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.36.0 \
        " \
