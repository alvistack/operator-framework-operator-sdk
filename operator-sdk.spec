...
set -ex && \
    ...
    go build \
        ...
        -ldflags "-s -w \
            -X github.com/operator-framework/operator-sdk/internal/version.Version=v1.17.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitVersion=v1.17.0 \
            -X github.com/operator-framework/operator-sdk/internal/version.GitCommit=704b02a9ba86e85f43edb1b20457859e9eedc6e6 \
            -X github.com/operator-framework/operator-sdk/internal/version.KubernetesVersion=v1.21 \
            -X github.com/operator-framework/operator-sdk/internal/version.ImageVersion=v1.17.0 \
        " \
